document.addEventListener('DOMContentLoaded', () => {
    ...
    yesBtn.addEventListener('click', () => {
        ...
        if (successSection) {
            ...
            successSection.style.display = 'block'; // Force display if class is not enough
        }

        if (happinessModal) happinessModal.classList.add('active');
